...
export default function NavBar() {
  const [offCanvasClicked, setOffCanvasClicked] = useState<boolean>(true);

  return (
    <nav className='flex items-center fixed z-10 top-0 bg-second-primary h-12 w-full px-4 dark:bg-navbar-dark'>
